...
class StaticDataService {
  static PersonalInfo getPersonalInfo() {
    return PersonalInfo(
      ...
      title: "Software Developer | RBT | Educator",
...
Render""",
      ...
      Project(
        ...
        title: "Betrack",
        description:
            'Betrack is a cross-platform app for recording and organizing behavioral data during observations. '
            'It supports common ABA and classroom measurement methods—including frequency, rate, duration, latency, '
            'interval recording, and permanent product—so practitioners can track target behaviors and review results later. '
            'Profiles organize students or clients and their target behaviors; sessions can be started immediately or with a timer and clicker. '
            'All data is stored locally on the device with no account or internet required, and observations can be exported as JSON or TSV.',
        technologies: """
Flutter,
Dart,
Local Storage,
Cross-Platform,
GitHub Pages""",
        githubUrl: "https://github.com/Rosie1028/Betrack",
        liveUrl: "https://rosie1028.github.io/Betrack/",
        featured: true,
